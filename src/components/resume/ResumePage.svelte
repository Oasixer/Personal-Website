...
<div id="outer_resume_page"
  ...
  <div id="inner_resume_page"
    ...
    <div class="flex flex-row flex-nowrap items-center gap-6 w-[100%]">
      ...
      {/if}
      <!-- <a class='flex flex-row flex-nowrap items-center text-sky-300 md:text-sz2xl md:mr-7' href='./kaelan_moffettsteinke_resume2024v3.pdf' download> -->
      <a class='flex flex-row flex-nowrap items-center text-sky-300 md:text-sz2xl md:mr-7' href='./kaelan_moffettsteinke_resume2024v4.pdf' download>
